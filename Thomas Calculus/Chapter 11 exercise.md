...
37. $r = \dfrac{1}{1+\cos\theta}$
#### Lines
Sketch the lines in Exercises 45–48 and find Cartesian equations for them.

45. $r\cos(\theta-\dfrac{\pi}{4})=\sqrt{2}$  
    $\dfrac{\sqrt{2}}{2}r\cos\theta + \dfrac{\sqrt{2}}{2}r\sin\theta = \sqrt{2}$  
    $\dfrac{1}{2}x + \dfrac{1}{2}y =1$
#### Circles
...
Graph the lines and conic sections in Exercises 65–74.

65. $r = 3 \sec (\theta - \dfrac{\pi}{3})$
### Practice Exercises
...
1. $x = \dfrac{t}{2}, y = t + 1; -\infty < t < \infty$  
   $y = 2x + 1$ line
#### Finding Parametric Equations and Tangent Lines
7. Find parametric equations and a parameter interval for the motion of a particle in the $xy$-plane that traces the ellipse $16x^2 + 9y^2 = 144$ once counterclockwise. (There are many ways to do this.)  
   $x = 3\cos\theta, y = 4\sin\theta. 0 \le \theta \le 2\pi$  
#### Lengths of Curves
Find the lengths of the curves in Exercises 13–19.

13. $y = x^{\frac{1}{2}} - \dfrac{1}{3}x^{\frac{3}{2}}, 1 \le x \le 4$  
    $\dfrac{dy}{dx} = \dfrac{1}{2\sqrt{x}} - \dfrac{1}{2}\sqrt{x}$  
    $l = \int_1^4\sqrt{1 + \dfrac{1}{4x} - \dfrac{1}{2} + \dfrac{1}{4}x}dx$  
    $= \int_1^4\dfrac{1}{2\sqrt{x}} + \dfrac{1}{2}\sqrt{x}dx$  
    $= [\sqrt{x} + \dfrac{1}{3}x^{\frac{3}{2}}]_1^4$  
    $= 2 + \dfrac{8}{3} - 1 - \dfrac{1}{3} = \dfrac{10}{3}$
#### Surface Areas
Find the areas of the surfaces generated by revolving the curves in Exercises 21 and 22 about the indicated axes.

21. $x = t^2, y = 2t, 0 \le t \le \sqrt{5}, x$-axis  
    $A = \int_0^{\sqrt{5}}2\pi2t\sqrt{4t^2 + 4}dt$  
    $= \pi\int_0^{\sqrt{5}}4t\sqrt{4t^2 + 4}dt$  
    $= \pi\int_4^{24}\dfrac{1}{2}\sqrt{u}du$  
    $= \dfrac{1}{2}\pi[\dfrac{2}{3}u^{\frac{3}{2}}]_4^{24}$  
    $= \dfrac{1}{2}\pi(32\sqrt{6}-\dfrac{16}{3})$  
    $= (16\sqrt{6}-\dfrac{8}{3})\pi$
#### Polar to Cartesian Equations
Sketch the lines in Exercises 23–28. Also, ind a Cartesian equation for each line.

23. $r\cos(\theta + \dfrac{\pi}{3}) = 2\sqrt{3}$  
    $\dfrac{1}{2}r\cos\theta - \dfrac{\sqrt{3}}{2}r\sin\theta = \sqrt{3}$  
    $x - \sqrt{3}y = 2\sqrt{3}$
#### Cartesian to Polar Equations
...
47. Enclosed by the limaçon $r = 2 - cos \theta$    
    $S = \int_0^{2\pi}\dfrac{1}{2}(4-4\cos\theta + cos^2\theta)d\theta$  
    $= \dfrac{1}{2}[4\theta -\sin\theta + \dfrac{1}{2}\theta +\dfrac{1}{4}\sin2\theta]_0^{2\pi}$  
    $= \dfrac{9}{2}\pi$
#### Length in Polar Coordinates
Find the lengths of the curves given by the polar coordinate equations in Exercises 51–54.

51. $r = -1 +\cos\theta$  
    $l = \int_0^{2\pi}\sqrt{1-2\cos\theta + \cos^2\theta + \sin^2\theta}d\theta$  
    $= \int_0^{2\pi}\sqrt{2- 2\cos\theta}d\theta$  
    $= \int_0^{2\pi}2\sin\dfrac{\theta}{2}d\theta$  
    $= |2[-2\cos\dfrac{\theta}{2}]_0^{2\pi}|$  
    $= 4$
...
69. $x^2 - 4x - 4y^2 = 0$  
    $(x -2)^2 -4y^2 = 4$  
    $\dfrac{(x-2)^2}{4} - y^2 = 1$  
    Hyperbola, $F(2\pm\sqrt{5},0),l:x = 2\pm 2y, C(2,0),A(0,0), B(4,0)$
...
77. $r =\dfrac{2}{1 + \cos\theta}$
#### Theory and Examples
85. Find the volume of the solid generated by revolving the region enclosed by the ellipse $9x^2 + 4y^2 = 36$ about (a) the $x$-axis, (b) the $y$-axis.  
    $\dfrac{x^2}{4} + \dfrac{y^2}{9} = 1$  
    $y = \dfrac{1}{2}\sqrt{36-9x^2}$   
    $x = \dfrac{1}{3}\sqrt{36-4y^2}$
    $V_a = 2\int_0^2\pi\dfrac{1}{4}(36-9x^2)dx$  
    $= \dfrac{\pi}{2}[36x - 3x^3]_0^2$  
    $=24\pi$  
    $V_b = 2\int_0^2\pi\dfrac{1}{9}(36-4y^2)dy$  
    $= \dfrac{\pi}{2}[36y - \dfrac{4}{3}x^3]_0^2$  
    $=\dfrac{92}{3}\pi$
...
11. $(x^2 - y^2 - 1)(x^2 + y^2 - 25)(x^2 + 4y^2 - 4) = 0$   
    One hyperbola, one circle, one ellipse
#### Polar Coordinates
17. a. Find an equation in polar coordinates for the curve
    $$
    x = e^{2t}\cos t, y = e^{2t}\sin t, -\infty < t < \infty
    $$
    b. Find the length of the curve from $t = 0$ to $t = 2\pi$  
    $x^2 + y^2 = e^{4t}$  
    $t = \dfrac{1}{4}\ln(x^2 + y^2)$  
    $x = e^{\frac{1}{2}\ln(x^2 + y^2)}\cos \dfrac{1}{4}\ln(x^2 + y^2)$  
    $= \sqrt{x^2 + y^2}\cos \dfrac{1}{4}\ln(x^2 + y^2)$  
    $r\cos\theta = \sqrt{r^2}\cos\dfrac{1}{4}\ln r^2$  
    $\cos\theta = \cos\ln\sqrt{r}$  
    b. $l = \int_0^{2\pi}\sqrt{(-\sin te^{2t} + 2e^{2t}\cos t)^2 + (e^{2t}\cos t + 2e^{2t}\sin t)^2}dt$  
    $= \int_0^{2\pi}\sqrt{5e^{4t}\cos^2t + 5e^{4t}\sin^2t}dt$  
    $= \sqrt{5}\int_0^{2\pi}\sqrt{e^{4t}}dt$  
    $= \sqrt{5}\dfrac{1}{2}e^{2t}]_0^{2\pi}$  
    $= \dfrac{\sqrt{5}}{2}e^{4\pi}- \dfrac{\sqrt{5}}{2}$
#### Theory and Examples
23. Epicycloids When a circle rolls externally along the circumference of a second, fixed circle, any point $P$ on the circumference of the rolling circle describes an epicycloid, as shown here. Let the fixed circle have its center at the origin $O$ and have radius $a$.  
    ![](../images/Thomas%20Calculus/11-5.jpg)  
    Let the radius of the rolling circle be $b$ and let the initial position of the tracing point $P$ be $A(a, 0)$. Find parametric equations for the epicycloid, using as the parameter the angle $\theta$ from the positive $x$-axis to the line through the circles’ centers.  
    $C((a+b)\cos\theta,(a+b)\sin\theta)$  
    $x = (a+b)\cos\theta + b\cos\theta,y=(a+b)\sin\theta + b\sin\theta$